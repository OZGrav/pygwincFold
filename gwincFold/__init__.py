...
logger = logging.getLogger('gwincFold')
...
def load_budget(name_or_path, freq=None, bname=None):
    ...
    if os.path.exists(name_or_path):
        ...
        modname = 'gwincFold.ifo.' + name_or_path
...
def gwinc(freq, ifo, source=None, plot=False, PRfixed=True):
    ...
    pbs = ifo.gwincFold.pbs
    parm = ifo.gwincFold.parm
    finesse = ifo.gwincFold.finesse
    prfactor = ifo.gwincFold.prfactor
